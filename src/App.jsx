...
function WorshipVideos() {
  const latestVideo = {
    title: "주일 낮 예배 | 주 안에서 하나되는 평화교회",
    date: "2026. 08. 23",
  };

  const recentVideos = [
    { id: 1, title: "수요예배 | 믿음으로 승리하는 삶", date: "2026. 08. 19", thumbnail: "https://images.unsplash.com/photo-1437604537877-09d5dd70ed29?auto=format&fit=crop&w=600&q=80" },
    { id: 2, title: "주일 낮 예배 | 평화를 누리는 성도", date: "2026. 08. 16", thumbnail: "https://images.unsplash.com/photo-1510590337019-5ef8d3d32116?auto=format&fit=crop&w=600&q=80" },
    { id: 3, title: "금요성령집회 | 부르심의 소망", date: "2026. 08. 14", thumbnail: "https://images.unsplash.com/photo-1507692049790-de58290a4334?auto=format&fit=crop&w=600&q=80" },
    { id: 4, title: "주일 낮 예배 | 은혜의 보좌 앞으로", date: "2026. 08. 09", thumbnail: "https://images.unsplash.com/photo-1438032005730-c779502df39b?auto=format&fit=crop&w=600&q=80" }
  ];
    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <a href="https://www.youtube.com/@TV-ue9if" target="_blank" rel="noopener noreferrer" className="block w-full aspect-[21/9] md:aspect-[21/9] bg-[#1a1a1a] rounded-3xl overflow-hidden shadow-2xl relative group">
            <div className="absolute inset-0">
               <img src="https://images.unsplash.com/photo-1438032005730-c779502df39b?auto=format&fit=crop&w=1600&q=80" alt="최근 예배영상 썸네일" className="w-full h-full object-cover opacity-60 group-hover:opacity-40 transition-opacity duration-500" />
            </div>
            <div className="absolute inset-0 flex flex-col justify-center items-center">
              <PlayCircle className="w-20 h-20 md:w-28 md:h-28 text-white opacity-90 group-hover:scale-110 transition-transform duration-500 shadow-sm rounded-full" />
            </div>
            <div className="absolute bottom-0 left-0 w-full p-8 md:p-12 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
              <span className="inline-block px-3 py-1 bg-[#8DC63F] text-black text-sm font-bold rounded-full mb-4">최신 영상</span>
              <h3 className="text-[24px] md:text-[40px] font-bold text-white mb-2 leading-tight">{latestVideo.title}</h3>
              <p className="text-[16px] md:text-[18px] text-white/70">{latestVideo.date}</p>
            </div>
          </a>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {recentVideos.map((video, idx) => (
            <motion.a
              href="https://www.youtube.com/@TV-ue9if"
              target="_blank"
...
function PastorGreeting() {
  return (
    <section 
      ...
      style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=1920&q=80")' }}
    >
